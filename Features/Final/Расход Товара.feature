...
Сценарий: Создание документа Продажа товара
	...
	*Проверка доступности Валюты взаиморасчетов в зависимости от выбранной организации	
		И из выпадающего списка с именем "Организация" я выбираю точное значение 'Не валютный учет"'
...
//		И я нажимаю на кнопку с именем "Получить ссылку..."
//		Когда открылось окно 'Получение ссылки'
//		И я нажимаю на кнопку с именем 'btnGetURL'
//		И я запоминаю значение поля "Ссылка" как "Ссылка"
